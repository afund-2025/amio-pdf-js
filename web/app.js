...
const PDFViewerApplication = {
  ...
  /**
   * Apply URL hash params that are not debug-specific (e.g. toolbar=0).
   * @private
   */
  _applyUrlParams() {
    ...
    console.log("[toolbar] hash:", hash);
    console.log("[toolbar] params.get('toolbar'):", params.get("toolbar"));
    console.log("[toolbar] toolbar container:", this.appConfig.toolbar?.container);
    if (params.get("toolbar") === "0") {
      const toolbarEl = this.appConfig.toolbar?.container?.closest(".toolbar");
      console.log("[toolbar] toolbarEl:", toolbarEl);
      toolbarEl?.classList.add("hidden");
      console.log("[toolbar] classList after:", toolbarEl?.classList.toString());
    }
  },
